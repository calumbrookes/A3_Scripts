...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		...
		["GrpNATO_A1", 1, "ALPHA", "ColorRed"] spawn f_fnc_localGroupMarker;
		...
		["GrpNATO_C1", 1, "CHARLIE", "ColorGreen"] spawn f_fnc_localGroupMarker;

		["GrpNATO_D1", 1, "DELTA", "ColorYellow"] spawn f_fnc_localGroupMarker;

		["GrpNATO_TH1",  9, "TH1", "ColorRed"] spawn f_fnc_localGroupMarker;
 		["GrpNATO_TH2",  9, "TH2", "ColorBlue"] spawn f_fnc_localGroupMarker;
 		["GrpNATO_TH3",  9, "TH3", "ColorGreen"] spawn f_fnc_localGroupMarker;
 		["GrpNATO_TH4",  9, "TH4", "ColorYellow"] spawn f_fnc_localGroupMarker;
		...
		["UnitNATO_ASL_M", 0, "MED", "ColorRed"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_BSL_M", 0, "MED", "ColorBlue"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_CSL_M", 0, "MED", "ColorGreen"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_DSL_M", 0, "MED", "ColorYellow"] spawn f_fnc_localSpecialistMarker;

		["sub_1", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_2", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_3", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_4", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_5", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_6", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_7", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_8", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_9", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_10", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
	};
