...
if(f_var_radios == 2) then {
	...
	_bagradio = TF_defaultEastBackpack;  //Remember to use "" for classnames eg "tf_rt1523g_sage"
	...
	case "crate_camp":
{
		...
		_rando1 = str(floor random 6);
		_rando2 = str(floor random 6);

	switch (_rando1) do {
  		case "1":
 		 {
			_unit addWeaponCargoGlobal ["rhs_weap_igla", 1];
			_unit addMagazineCargoGlobal ["rhs_mag_9k38_rocket", 1];
 		 };

 		 case "2":
 		 {
 		 	_unit addWeaponCargoGlobal [_AR, 1];
			_unit addMagazineCargoGlobal [_armag, 2];
		 };

 		 case "3":
		 {
			_unit addWeaponCargoGlobal ["tf47_m3maaws", 1];
			_unit addMagazineCargoGlobal ["tf47_m3maaws_HEDP", 3];
 		 };
 		 
 		 case "4":
		 {
			_unit addWeaponCargoGlobal ["arifle_ARX_blk_F", 1];
			_unit addMagazineCargoGlobal ["30Rnd_65x39_caseless_green", 5];
			_unit addMagazineCargoGlobal ["10Rnd_50BW_Mag_F", 2];
 		 };
 		 
 		 case "5":
		 {
			_unit addWeaponCargoGlobal ["rhs_weap_svdp", 1];
			_unit addMagazineCargoGlobal ["rhs_10Rnd_762x54mmR_7N1", 6];
			_unit addItemCargoGlobal ["rhs_acc_pso1m21_svd",1];
 		 };
 		 default
 		 {
		...
		switch (_rando2) do {
  		case "1":
 		 {
			_unit addItemCargoGlobal ["U_B_T_FullGhillie_tna_F",1];
 		 };
 		 ...
 		 case "3":
		 {
 		 ...
 		 case "4":
		 {
			_unit addItemCargoGlobal ["FHQ_optic_AimM_BLK",2];
 		 };
		...
		_unit addBackpackCargoGlobal ["B_ViperLightHarness_blk_F",1];
		_unit addWeaponCargoGlobal [_carbine, 1];
		_unit addMagazineCargoGlobal [_riflemag, 2];
	...
	case "crate_med":
{
		...
		clearItemCargoGlobal _unit;
		clearBackpackCargoGlobal _unit;
		_unit addItemCargoGlobal ["ItemMap",1];
		_unit addItemCargoGlobal ["ItemCompass",2];
		_unit addItemCargoGlobal [_nvg,12];
		_unit addWeaponCargoGlobal [_carbine, 2];
		_unit addWeaponCargoGlobal [_pistol, 2];
