...
_baseUniform = ["Cre8ive_CU_Uniform_Civ_24"];
_baseHelmet = ["rhsgref_un_beret"];
_baseGlasses = [];
	...
	case "crate_med":
{
		...
		clearItemCargoGlobal _unit;
		clearBackpackCargoGlobal _unit;
		_unit addItemCargoGlobal ["ItemMap",2];
		_unit addItemCargoGlobal ["ItemGPS",2];
	...
	case "crate_scuba":
{
		...
		clearItemCargoGlobal _unit;
		clearBackpackCargoGlobal _unit;
		_unit addItemCargoGlobal ["U_B_Wetsuit", 4];
		_unit addItemCargoGlobal ["V_RebreatherB", 4];
		_unit addItemCargoGlobal ["G_Diving", 4];
		_unit addItemCargoGlobal ["FHQ_optic_AimM_BLK", 4];
		_unit addWeaponCargoGlobal [_rifle, 4];
		_unit addMagazineCargoGlobal [_riflemag, 20];
		_unit addMagazineCargoGlobal [_pistolmag, 8];
		_unit addItemCargoGlobal [_firstaid, 25];		
};
