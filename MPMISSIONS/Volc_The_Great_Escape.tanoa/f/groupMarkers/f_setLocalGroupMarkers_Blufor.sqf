...
// Markers seen by players in NATO, NATO (Pacific) & CTRG slots.
	...
	["GrpNATO_A1", _ft, "A1", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpNATO_A2", _ft, "A2", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpNATO_A3", _ft, "A3", "ColorRed"] spawn f_fnc_localGroupMarker;

	["GrpNATO_BSL", _hq, "BSL", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_B1", _ft, "B1", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_B2", _ft, "B2", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_B3", _ft, "B3", "ColorBlue"] spawn f_fnc_localGroupMarker;

	["GrpNATO_CSL", _hq, "CSL", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["GrpNATO_C1", _ft, "C1", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["GrpNATO_C2", _ft, "C2", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["GrpNATO_C3", _ft, "C3", "ColorGreen"] spawn f_fnc_localGroupMarker;
	...
	["GrpNATO_IFV1",  _ifv, "IFV1", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpNATO_IFV2",  _ifv, "IFV2", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpNATO_IFV3",  _ifv, "IFV3", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_IFV4",  _ifv, "IFV4", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_IFV5",  _ifv, "IFV5", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["GrpNATO_IFV6",  _ifv, "IFV6", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["GrpNATO_IFV7",  _ifv, "IFV7", "ColorOrange"] spawn f_fnc_localGroupMarker;
	["GrpNATO_IFV8",  _ifv, "IFV8", "ColorOrange"] spawn f_fnc_localGroupMarker;
	...
	["UnitNATO_CO_M", _hq, "COM", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
	["UnitNATO_DC_M", _hq, "DCM", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
	["UnitNATO_ASL_M", _hq, "AM", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
	["UnitNATO_BSL_M", _hq, "BM", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
	["UnitNATO_CSL_M", _hq, "CM", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
...
// Markers seen by players in FIA & CTRG slots.
	...
	["GrpIFIA_A3",_ft, "A3", "ColorRed"] spawn f_fnc_localGroupMarker;
