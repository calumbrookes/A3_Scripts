...
// Markers seen by players in CSAT & CSAT (Pacific) slots.
	...
	["GrpCSAT_TH3",_hel, "SH1", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpCSAT_TH4",_hel, "SH2", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpCSAT_TH5",_hel, "TH1", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpCSAT_TH6",_hel, "TH2", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpCSAT_TH7",_hel, "TH3", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpCSAT_TH8",_hel, "TH4", "ColorRed"] spawn f_fnc_localGroupMarker;
