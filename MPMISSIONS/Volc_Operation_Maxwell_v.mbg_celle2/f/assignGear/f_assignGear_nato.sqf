...
_bagmedium = "B_AssaultPack_rgr";				// carries 240, weighs 30
...
_baseGlasses = ["UK3CB_BAF_G_Tactical_Black"];
...
_crewHelmet = ["UK3CB_BAF_H_Beret_RTR_PRR"];
_crewRig = ["V_TacVest_oli"];
_crewGlasses = ["Mask_M40"];
...
// Spec Op
_sfuniform = ["U_B_CTRG_1"];
_sfhelmet = ["UK3CB_BAF_H_Beret_REng_PRR"];
_sfRig = ["V_PlateCarrierH_CTRG"];
_sfGlasses = ["Mask_M40"];
...
// LOADOUT: MEDIC
	...
	{	
		...
		_unit addHeadgear "UK3CB_BAF_H_Beret_RAMC_Officer_PRR";
...
// LOADOUT: HEAVY AT GUNNER
	...
	{
		removeHeadgear _unit;
		_unit addHeadgear "UK3CB_BAF_H_Beret_RA_PRR";
		_unit addmagazines [_carbinemag,7];
		_unit addweapon _carbine;
		_unit addmagazines [_pistolmag,2];
		_unit addweapon _pistol;
