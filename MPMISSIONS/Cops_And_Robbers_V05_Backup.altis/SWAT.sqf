...
_crate addWeaponCargoGlobal["UK3CB_BAF_L128A1",20];
_crate addWeaponCargoGlobal["rhs_weap_m4a1_carryhandle",20];
_crate addWeaponCargoGlobal["UK3CB_BAF_L129A1",20];
...
_crate addMagazineCargoGlobal["rhs_mag_30Rnd_556x45_Mk318_Stanag",100];
_crate addMagazineCargoGlobal["UK3CB_BAF_L128A1_Slugs",100];
_crate addMagazineCargoGlobal["UK3CB_BAF_L128A1_Pellets",100];
_crate addMagazineCargoGlobal["UK3CB_BAF_20Rnd",100];
