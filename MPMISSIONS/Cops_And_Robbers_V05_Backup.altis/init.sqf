...
// Credits: mbetts
[] spawn {
while {not isnull r1} do { "rm1" setmarkerpos (r1 modelToWorld [0,0,0]); sleep 0.5; };
};

[] spawn {
while {not isnull r2} do { "rm2" setmarkerpos (r2 modelToWorld [0,0,0]); sleep 0.5; };
};

[] spawn {
while {not isnull r3} do { "rm3" setmarkerpos (r3 modelToWorld [0,0,0]); sleep 0.5; };
};

[] spawn {
while {not isnull r4} do { "rm4" setmarkerpos (r4 modelToWorld [0,0,0]); sleep 0.5; };
};

[] spawn {
while {not isnull r5} do { "rm5" setmarkerpos (r1 modelToWorld [0,0,0]); sleep 0.5; };
};
