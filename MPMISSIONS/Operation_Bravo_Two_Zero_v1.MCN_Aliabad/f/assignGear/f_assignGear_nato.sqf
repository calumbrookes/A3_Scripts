...
// ATTACHMENTS - PRIMARY
_attach1 = "UK3CB_BAF_LLM_Flashlight_Black";	// IR Laser
_attach2 = "UK3CB_BAF_LLM_IR_Black";			// Flashlight

_silencer1 = "muzzle_snds_M";					// 5.56 suppressor
_silencer2 = "muzzle_snds_H";					// 6.5 suppressor

_scope1 = "UK3CB_BAF_SpecterLDS_3D";			// Holosight
_scope2 = "UK3CB_BAF_TA648_308";				// MRCO Scope - 1x - 6x
...
_baseHelmet = ["UK3CB_BAF_H_Headset_PRR","H_Watchcap_blk","H_Booniehat_khk_hs","H_Shemag_tan","UK3CB_BAF_H_Mk7_Camo_ESS_B"];
_baseGlasses = [];
...
// Crewman
_crewUniform = ["UK3CB_BAF_U_CombatUniform_MTP_TShirt"];
_crewHelmet = ["UK3CB_BAF_H_CrewHelmet_ESS_A"];
_crewRig = ["V_Rangemaster_belt"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["UK3CB_BAF_U_CombatUniform_MTP_Ghillie_RM"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = [];
_ghillieRig = ["UK3CB_BAF_V_Osprey_Marksman_A"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["UK3CB_BAF_U_CombatUniform_MTP"];
_sfhelmet = ["UK3CB_BAF_H_Beret_RAMC_Officer_PRR","UK3CB_BAF_H_Beret_RAMC_PRR"];
_sfRig = ["UK3CB_BAF_V_Osprey_Medic_A","UK3CB_BAF_V_Osprey_Medic_B","UK3CB_BAF_V_Osprey_Medic_C","UK3CB_BAF_V_Osprey_Medic_D"];
_sfGlasses = [];
