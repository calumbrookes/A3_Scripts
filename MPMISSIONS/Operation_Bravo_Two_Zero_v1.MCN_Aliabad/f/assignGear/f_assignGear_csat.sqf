...
_Mgrenade = "rhs_mag_rgo";
_smokegrenade = "rhs_mag_rdg2_white";
_smokegrenadegreen = "rhs_mag_nspn_red";
...
// Woodland-Hex
_baseUniform = ["MNP_CombatUniform_6CO_B","MNP_CombatUniform_6CO"];
_baseHelmet = ["MNP_Beret_2PARA"];
_baseGlasses = ["G_Aviator","G_Bandanna_tan","G_Bandanna_aviator"];
...
_crewHelmet = ["MNP_Beret_2PARA"];
_crewRig = ["V_BandollierB_khk"];
_crewGlasses = ["G_Aviator"];
