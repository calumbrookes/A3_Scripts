...
private ["_maxdudes","_bglass","_thenumwip","_thenum","_bcurtemp","_bcur","_tmpwip","_cPos","_pos","_num1","_num2","_skill","_unitlist","_geararray","_tmp","_min","_max","_h","_grp","_ranDir","_xPos"];
