...
_scope1 = "rhs_acc_1p29";		// dot  hlc_optic_kobra HLC_Optic_PSO1	HLC_Optic_1p29
_scope2 = "rhs_acc_1p29";		// RPK ak74gl
_scope3 = "rhs_acc_pgo7v";			//RPG -  rhs_acc_pso1m2
_scope4 = "optic_MRCO";			// SF G3s
...
_carbine = "hlc_rifle_ak74_dirty2";
...
// Rifleman AT
_RAT = "rhs_weap_rpg7";	//rhs_weap_rpg7 UK3CB_BAF_AT4_AP_Launcher
_RATmag = "rhs_rpg7_PG7VL_mag";  //rhs_rpg7_PG7VL_mag rhs_rpg7_PG7VR_mag rhs_rpg7_OG7V_mag UK3CB_BAF_AT4_AP_Mag
_RATmag2 = "rhs_rpg7_PG7VL_mag"; 
...
// desert fallu mix
_baseUniform = ["MNP_CombatUniform_AMerc_5","MNP_CombatUniform_Militia_DC","MNP_CombatUniform_Militia_DE","MNP_CombatUniform_Militia_DF","MNP_CombatUniform_Militia_DA","MNP_CombatUniform_Militia_DB","MNP_CombatUniform_Militia_F","MNP_CombatUniform_Militia_E","MNP_CombatUniform_Militia_F","MNP_CombatUniform_AMerc_3"];
_baseHelmet = [];
_baseGlasses = ["G_Bandanna_tan","G_Bandanna_khk","G_Bandanna_aviator","G_Bandanna_shades","G_Bandanna_oli"];

// wood partly des
//_baseUniform = ["MNP_CombatUniform_AMerc_5","MNP_CombatUniform_Militia_DB","MNP_CombatUniform_Militia_DE","MNP_CombatUniform_AMerc_1","MNP_CombatUniform_Militia_DC"];
//_baseHelmet = [];//["H_ShemagOpen_tan","H_ShemagOpen_khk","H_ShemagOpen_tan","H_ShemagOpen_khk","H_Shemag_olive"];
//_baseGlasses = ["G_Balaclava_blk","G_Balaclava_oli"]; //"G_Balaclava_blk","G_Balaclava_oli"
...
// Armored vests
_lightRig = ["MNP_Vest_Australia","MNP_Vest_CZ_2","MNP_Vest_CZ_2","V_HarnessOGL_brn","V_BandollierB_cbr"];
_mediumRig = ["MNP_Vest_Australia","MNP_Vest_CZ_2","MNP_Vest_CZ_2","V_HarnessOGL_brn","V_BandollierB_cbr"]; 	// default for all infantry classes MNP_Vest_CZ_1 MNP_Vest_OD_B V_PlateCarrierIA1_dgtl
_heavyRig = ["MNP_Vest_Australia","MNP_Vest_CZ_2","MNP_Vest_CZ_2","V_HarnessOGL_brn","V_BandollierB_cbr"];
...
// Ghillie
_ghillieUniform = ["MNP_CombatUniform_AMerc_5","MNP_CombatUniform_Militia_DC","MNP_CombatUniform_Militia_DE","MNP_CombatUniform_Militia_DF","MNP_CombatUniform_Militia_DA","MNP_CombatUniform_Militia_DB","MNP_CombatUniform_Militia_F","MNP_CombatUniform_Militia_E","MNP_CombatUniform_Militia_F","MNP_CombatUniform_AMerc_3"];
_ghillieHelmet = [];
_ghillieRig = ["MNP_Vest_Australia"];
_ghillieGlasses = ["G_Balaclava_blk","G_Balaclava_oli"];

// Spec Op
_sfuniform = ["MNP_CombatUniform_DDPMR"];
_sfhelmet = ["MNP_Helmet_SOV_Steel"];
_sfRig = ["MNP_Vest_Australia"];
_sfGlasses = ["rhs_scarf"];
...
if (_isMan) then {
	...
	//_thehead = selectRandom ["AfricanHead_01","AfricanHead_02","AfricanHead_03"] ;  //wait fort 1.55
	_thehead = ["AfricanHead_01","AfricanHead_02","AfricanHead_03"] call BIS_fnc_selectRandom;
	_unit setFace _thehead;
