...
_scope6 = "FHQ_optic_MicroCCO"; // vehicle crew
...
_bagmedium = "B_Kitbag_cbr";	// carries 240, weighs 30  B_TacticalPack_blk
...
_baseUniform = ["MNP_CombatUniform_NOR_D_A","MNP_CombatUniform_NOR_D_B"];
_baseHelmet = ["MNP_Boonie_NOR_D"]; //rhsusf_ach_helmet_ESS_ucp
_baseGlasses = [""];

// Armored vests
_lightRig = ["MNP_Vest_NOR_D_1"];
_mediumRig = ["MNP_Vest_NOR_D_1"]; 	// default for all infantry classes
_heavyRig = ["MNP_Vest_NOR_D_1"];
...
// Spec Op
_sfuniform = ["MNP_CombatUniform_NOR_D_B"];
