...
_scope1 = "optic_Arco";	// Holosight  rhsusf_acc_ACOG2
_scope2 = "optic_Aco_smg";			// MRCO Scope - 1x - 6x optic_MRCO rhsusf_acc_compm4
_scope3 = "optic_SOS";			// SOS Scope - 18x - 75x
_scope4 = "rhs_acc_1p29"; // MG scope 
_scope6 = "optic_AMS"; // SNIPER
...
// WEAPON SELECTION
/*_Eriflemag1 = "rhs_mag_30Rnd_556x45_M855A1_Stanag";
_Eriflemag2 = "BWA3_30Rnd_556x45_G36";
_Eriflemag3 = "hlc_30Rnd_545x39_EP_ak";
_EARmag1 = "rhsusf_100Rnd_556x45_soft_pouch";
_EARmag2 = "BWA3_200Rnd_556x45";
_EARmag3 = "rhs_100Rnd_762x54mmR";
_Esmgmag1 = "hlc_30Rnd_9x19_B_MP5";
_EMATmag1 = "NLAW_F"; //rhs_fgm148_magazine_AT
_EMAT2 = "BWA3_Pzf3";
_EMATmag2 = "BWA3_Pzf3_IT";
_EMATmag3 = "NLAW_F"; //rhs_fgm148_magazine_AT*/
...
_smgmag = "hlc_30Rnd_545x39_EP_ak";
...
// Backpacks
_bagsmall = "B_FieldPack_khk";			// carries 120, weighs 20   B_FieldPack_khk  wood MNP_B_RU2_FP
_bagmedium = "B_FieldPack_khk";				// carries 240, weighs 30  B_FieldPack_khk
_baglarge =  "B_Carryall_khk"; 			// carries 320, weighs 40   B_Carryall_khk   wood MNP_B_RU2_CA
_bagmediumdiver =  "B_FieldPack_khk";		// used by divers
...
// Medium AT
_MAT = "launch_RPG32_F"; //rhs_weap_fgm148
_MATmag1 = "RPG32_F"; //rhs_fgm148_magazine_AT 
_MATmag2 = "RPG32_HE_F"; //rhs_fgm148_magazine_AT
...
// Sniper
_SNrifle = "rhs_weap_svdp_wd_npz";//optic_AMS
...
_baseUniform = ["MNP_CombatUniform_RU_Med_DB","MNP_CombatUniform_RU_Med_D"]; // wood "MNP_CombatUniform_RU_Med","MNP_CombatUniform_RU_Med_B"
_baseHelmet = ["MNP_Helmet_PAGST_RD"]; //  rhs_6b27m_green rhs_6b27m_digi  wood MNP_Helmet_PAGST_RT
_baseGlasses = [];

// Armored vests
_lightRig = ["MNP_Vest_ISRKahki_2"]; //MNP_Vest_RU_D2 
_mediumRig = ["MNP_Vest_ISRKahki_2"]; 	// wood MNP_Vest_TS_1
_heavyRig = ["MNP_Vest_ISRKahki_2"];
...
// Pilot
_pilotUniform = ["MNP_CombatUniform_RU_Med_D"]; // MNP_CombatUniform_RU_Med
_pilotHelmet = ["rhs_zsh7a_mike"];
_pilotRig = ["MNP_Vest_Light_R3"]; //MNP_Vest_Light_R3
_pilotGlasses = [];

// Crewman
_crewUniform = ["MNP_CombatUniform_RU_Med_DB"]; // MNP_CombatUniform_RU_Med_B
_crewHelmet = ["rhs_tsh4"];
_crewRig = ["MNP_Vest_Light_R3"]; //MNP_Vest_Light_R3
_crewGlasses = [];
...
// Spec Op
_sfuniform = ["MNP_CombatUniform_RU_Med_B"]; //MNP_CombatUniform_RU_Med_DB
_sfhelmet = ["rhs_6b27m_digi"]; //MNP_Helmet_PAGST_RD MNP_Helmet_PAGST_RT
_sfRig = _mediumRig;
_sfGlasses = [];
...
_backpack = {
	...
	{
		#include "f_assignGear_us_delta_b.sqf";
	};
};
