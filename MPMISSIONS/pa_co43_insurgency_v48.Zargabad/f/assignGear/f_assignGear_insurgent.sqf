...
// deserty-Hex
//_baseUniform = ["MNP_CombatUniform_US3Co_Sh","MNP_CombatUniform_Militia_DC","MNP_CombatUniform_Militia_DE","MNP_CombatUniform_Militia_DF","MNP_CombatUniform_Militia_DA","MNP_CombatUniform_Militia_DB"];
//_baseHelmet = ["H_Shemag_olive","H_ShemagOpen_tan","H_ShemagOpen_khk"];
//_baseGlasses = [];

//altis
_baseUniform = ["U_BG_Guerilla1_1","U_BG_leader","MNP_CombatUniform_Rebel_A","MNP_CombatUniform_Militia_F","MNP_CombatUniform_Militia_E"];
_baseHelmet = [];
...
// Armored vests
_lightRig = ["MNP_Vest_OD_A","MNP_Vest_CZ_2","MNP_Vest_CZ_2","V_HarnessOGL_gry"];
_mediumRig = ["MNP_Vest_OD_A","MNP_Vest_CZ_2","MNP_Vest_CZ_2","V_HarnessOGL_gry"]; 	// default for all infantry classes MNP_Vest_CZ_1 MNP_Vest_OD_B V_PlateCarrierIA1_dgtl
_heavyRig = ["MNP_Vest_OD_A","MNP_Vest_CZ_2","MNP_Vest_CZ_2","V_HarnessOGL_gry"];
...
// Ghillie
_ghillieUniform = ["U_BG_Guerilla1_1","U_BG_leader","MNP_CombatUniform_Rebel_A","MNP_CombatUniform_Militia_F","MNP_CombatUniform_Militia_E"];
_ghillieHelmet = [];
