...
_baseHelmet = ["rhsusf_ach_bare_tan_headset"]; //rhsusf_ach_bare_headset "H_HelmetB_light_desert","H_HelmetB_light_sand" -----"rhsusf_ach_helmet_ESS_ucp" = bad
_baseGlasses = ["G_Lowprofile","G_Shades_Black","G_Shades_Red","G_Sport_Blackred","G_Aviator"];
...
_pilotRig = ["V_PlateCarrier1_blk"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["rhs_uniform_cu_ucp"];
_crewHelmet = ["H_HelmetCrew_I"];
_crewRig = ["V_PlateCarrier2_rgr"]; // rhsusf_iotv_ocp
_crewGlasses = [];
