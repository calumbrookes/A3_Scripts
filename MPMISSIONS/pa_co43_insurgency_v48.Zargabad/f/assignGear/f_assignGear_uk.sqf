...
_riflemag_tr = "UK3CB_BAF_30Rnd_T";
...
_glriflemag_tr = "UK3CB_BAF_30Rnd_T";
_glmag = "1Rnd_HE_Grenade_shell";
_glmag2 = "UK3CB_BAF_1Rnd_HEDP_Grenade_shell";
...
// Backpacks
_bagsmall = "B_Kitbag_mcamo";			// carries 120, weighs 20
_bagmedium = "B_Kitbag_mcamo";				// carries 240, weighs 30
_baglarge =  "B_Kitbag_mcamo"; 			// carries 320, weighs 40
//if (_typeofUnit == "m") then {
//_bagsmall = "UK3CB_BAF_B_Bergen_MTP_Medic_L_A";			// carries 120, weighs 20
//_bagmedium = "UK3CB_BAF_B_Bergen_MTP_Medic_L_A";				// carries 240, weighs 30
//_baglarge =  "UK3CB_BAF_B_Bergen_MTP_Medic_L_A"; 			// carries 320, weighs 40
//};
...
_baseHelmet = ["UK3CB_BAF_H_Mk7_Camo_D","UK3CB_BAF_H_Mk7_Camo_ESS_D"]; //rhsusf_ach_helmet_ESS_ucp
_baseGlasses = [];

// Armored vests
_lightRig = ["UK3CB_BAF_V_Osprey_Rifleman_F","UK3CB_BAF_V_Osprey_Rifleman_E"];
_mediumRig = ["UK3CB_BAF_V_Osprey_Rifleman_F","UK3CB_BAF_V_Osprey_Rifleman_E"]; 	// default for all infantry classes
_heavyRig = ["UK3CB_BAF_V_Osprey_Rifleman_F","UK3CB_BAF_V_Osprey_Rifleman_E"];
...
// Pilot
_pilotUniform = ["UK3CB_BAF_U_CombatUniform_MTP_TShirt"];
_pilotHelmet = ["H_PilotHelmetHeli_O"];
_pilotRig = ["UK3CB_BAF_V_Pilot_A"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["UK3CB_BAF_U_CombatUniform_MTP_TShirt_RM"];
_crewHelmet = ["UK3CB_BAF_H_CrewHelmet_A"];
_crewRig = ["UK3CB_BAF_V_Osprey_Holster"];
_crewGlasses = [];
...
// Spec Op
_sfuniform = ["UK3CB_BAF_U_CombatUniform_MTP_TShirt_RM"];
_sfhelmet = ["UK3CB_BAF_H_Beret_RM_Officer_PRR"];
_sfRig = _mediumRig;
_sfGlasses = [];
