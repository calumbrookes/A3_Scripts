...
pvpfw_cleanup_abandonedFromFaction = ["BLU_F","OPF_F","IND_F","blu_g_f","opf_g_f","ind_g_f","CIV_F","UK3CB_BAF_Faction","BWA3_Faction","rhs_faction_msv","rhs_faction_usarmy_d","rhs_faction_usarmy_usaf"]; // Vehicles from these factions will be cleaned up
pvpfw_cleanUp_abandonRadius = 300; // If no unit is closer than the specified distance, the removal countdown will start
pvpfw_cleanup_abandondTimer = 360; // The vehicle will be removed after the specified time
pvpfw_cleanUp_dontCleanUpAround = ["respawn_west","respawn_east",mobileHQ,"nogo2"]; //do not clean abandoned vehicles around these markers
pvpfw_cleanUp_dontCleanUpAroundDistance = 50; // Dont clean if the vehicle is in this range of one of the above markers.
...
pvpfw_cleanUp_vehicleTimer = 240;

//////////////////
// Clean bodies //
//////////////////
pvpfw_cleanUp_bodyTimer = 240; // Bodies will be removed after the specified amount of seconds
...
pvpfw_cleanUp_weaponHolderTimer = 240; // Weaponholders will be deleted after this time
...
pvpfw_cleanUp_ruinRadius = 500; // Destroyed Buildings will be deleted if no entity is in the specified range around them
