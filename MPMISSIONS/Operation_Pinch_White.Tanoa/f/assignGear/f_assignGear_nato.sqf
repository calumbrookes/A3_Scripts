...
_silencer1 = "SMA_supp2bSCAR_556";	// 5.56 suppressor
_silencer2 = "muzzle_snds_B";	// 6.5 suppressor

_scope1 = "FHQ_optic_AC11704";	// Holosight
...
// Default setup
_attachments = [_attach2,_scope1,_silencer1]; // The default attachment set for most units, overwritten in the individual unitType
...
_rifle = "SMA_Mk16_blackQCB";
_riflemag = "SMA_30Rnd_556x45_M855A1";
_riflemag_tr = "SMA_30Rnd_556x45_M855A1";
...
// Backpacks
_bagsmall = "B_ViperLightHarness_blk_F";			// carries 120, weighs 20
_bagmedium = "B_ViperLightHarness_blk_F";				// carries 240, weighs 30
_baglarge =  "B_ViperLightHarness_blk_F"; 			// carries 320, weighs 40
_bagmediumdiver =  "B_ViperLightHarness_blk_F";		// used by divers
...
// Vests
_lightRig = ["V_RebreatherB","V_RebreatherB"];
_mediumRig = ["V_RebreatherB","V_RebreatherB"]; 	// default for all infantry classes
...
// LOADOUT: DEPUTY COMMANDER AND SQUAD LEADER
	case "dc":
	{
		...
		_unit addmagazines [_pistolmag,2];
		_unit addmagazines ["B_IR_Grenade",3];
		_unit addmagazines ["rhs_mag_mk84",3];
		_unit addmagazines ["rhs_mag_mk3a2",3];
		_unit addweapon _pistol;
		_unit addWeapon "Rangefinder";
		["g"] call _backpack;
	};
...
// LOADOUT: DESIGNATED MARKSMAN
	case "dm":
	{
		...
		_unit addweapon _pistol;
		["dm"] call _backpack;
		_attachments = [_attach2,_scope3,_silencer2];
		_unit addWeapon "Rangefinder";
	};
