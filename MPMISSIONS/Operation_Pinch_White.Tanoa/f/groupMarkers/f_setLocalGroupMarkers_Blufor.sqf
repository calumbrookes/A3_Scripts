...
// Markers seen by players in NATO, NATO (Pacific) & CTRG slots.
	...
	["GrpNATO_A1",_ft, "APOLLO", "ColorRed"] spawn f_fnc_localGroupMarker;
	...
	["GrpNATO_B1",_ft, "MERCURY", "ColorBlue"] spawn f_fnc_localGroupMarker;
	...
	["GrpNATO_C1",_ft, "MARS", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["GrpNATO_C2",_ft, "C2", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["GrpNATO_CV",_ifv, "CV", "ColorGreen"] spawn f_fnc_localGroupMarker;

	["GrpNATO_DSL",_hq, "DSL", "ColorYellow"] spawn f_fnc_localGroupMarker;
	["GrpNATO_D1",_ft, "NEPTUNE", "ColorYellow"] spawn f_fnc_localGroupMarker;
	["GrpNATO_D2",_ft, "D2", "ColorYellow"] spawn f_fnc_localGroupMarker;
	["GrpNATO_DV",_ifv, "DV", "ColorYellow"] spawn f_fnc_localGroupMarker;
	...
	["UnitNATO_DSL_M",_med, "DM", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
