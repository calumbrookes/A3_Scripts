...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		...
		["GrpNATO_DC", 0, "SAS", "ColorBlack"] spawn f_fnc_localGroupMarker;
		...
		["GrpNATO_D1", 0, "JAGUAR", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpNATO_D2", 0, "PUMA", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpNATO_D3", 0, "OCELOT", "ColorBlack"] spawn f_fnc_localGroupMarker;
		...
		["UnitNATO_CO_M", 0, "MED", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_DC_M", 0, "MED", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		...
		["UnitNATO_A3_M", 0, "MED", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_B3_M", 0, "MED", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_C3_M", 0, "MED", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
