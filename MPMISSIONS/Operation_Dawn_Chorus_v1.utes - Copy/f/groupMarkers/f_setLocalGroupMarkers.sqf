...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		["GrpNATO_CO", 0, "CMD", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpNATO_DC", 0, "CMD", "ColorYellow"] spawn f_fnc_localGroupMarker;
		...
		["VehNATO_TH4", 0, "TH4", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["VehNATO_TH5", 0, "TH5", "ColorBlack"] spawn f_fnc_localSpecialistMarker;

		["sdv1", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sdv2", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sdv3", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sdv4", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sdv5", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sdv6", 0, "SDV", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
	};
