...
// Markers seen by players in NATO, NATO (Pacific) & CTRG slots.
	...
	["GrpNATO_CO",_hq, "CMD", "ColorYellow"] spawn f_fnc_localGroupMarker;
	["GrpNATO_DC",_tnk, "TNK", "ColorRed"] spawn f_fnc_localGroupMarker;

	["GrpNATO_ASL",_ft, "INF", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_A1",_ft, "INF", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_A2",_ft, "INF", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_A3",_ft, "INF", "ColorBlue"] spawn f_fnc_localGroupMarker;

	["GrpNATO_BSL",_ft, "INF", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_B1",_ft, "INF", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_B2",_ft, "INF", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_BV",_ft, "INF", "ColorBlue"] spawn f_fnc_localGroupMarker;

	["GrpNATO_CSL",_ft, "INF", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_C1",_ft, "INF", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_C2",_ft, "INF", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["GrpNATO_CV",_ft, "INF", "ColorBlue"] spawn f_fnc_localGroupMarker;
	...
	["GrpNATO_MSAM1",  _sup, "AA", "ColorOrange"] spawn f_fnc_localGroupMarker;
	["GrpNATO_HSAM1",  _lau, "AA", "ColorOrange"] spawn f_fnc_localGroupMarker;
	...
	["GrpNATO_ENG1",  _eng, "ENG", "ColorOrange"] spawn f_fnc_localGroupMarker;

	["GrpNATO_IFV1",  _tnk, "TNK", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpNATO_IFV2",  _tnk, "TNK", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpNATO_IFV3",  _tnk, "TNK", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpNATO_IFV4",  _tnk, "TNK", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpNATO_IFV5",  _tnk, "TNK", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpNATO_IFV6",  _tnk, "TNK", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpNATO_IFV7",  _tnk, "TNK", "ColorRed"] spawn f_fnc_localGroupMarker;
	["GrpNATO_IFV8",  _tnk, "TNK", "ColorRed"] spawn f_fnc_localGroupMarker;
...
["GrpFIA_A3", _ft, "A3", "ColorRed"] spawn f_fnc_localGroupMarker;
...
["GrpFIA_B3", _ft, "B3", "ColorBlue"] spawn f_fnc_localGroupMarker;
...
["GrpFIA_C3", _ft, "C3", "ColorGreen"] spawn f_fnc_localGroupMarker;
...
["GrpFIA_MSAM1",  _sup, "MSAM1", "ColorOrange"] spawn f_fnc_localGroupMarker;
["GrpFIA_HSAM1",  _sup, "HSAM1", "ColorOrange"] spawn f_fnc_localGroupMarker;
["GrpFIA_ST1",  _lau, "ST1", "ColorOrange"] spawn f_fnc_localGroupMarker;
["GrpFIA_DT1",  _lau, "DT1", "ColorOrange"] spawn f_fnc_localGroupMarker;
["GrpFIA_ENG1",  _eng, "ENG1", "ColorOrange"] spawn f_fnc_localGroupMarker;

["GrpFIA_IFV1",  _ifv, "IFV1", "ColorRed"] spawn f_fnc_localGroupMarker;
["GrpFIA_IFV2",  _ifv, "IFV2", "ColorRed"] spawn f_fnc_localGroupMarker;
["GrpFIA_IFV3",  _ifv, "IFV3", "ColorBlue"] spawn f_fnc_localGroupMarker;
["GrpFIA_IFV4",  _ifv, "IFV4", "ColorBlue"] spawn f_fnc_localGroupMarker;
["GrpFIA_IFV5",  _ifv, "IFV5", "ColorGreen"] spawn f_fnc_localGroupMarker;
["GrpFIA_IFV6",  _ifv, "IFV6", "ColorGreen"] spawn f_fnc_localGroupMarker;
["GrpFIA_IFV7",  _ifv, "IFV7", "ColorOrange"] spawn f_fnc_localGroupMarker;
["GrpFIA_IFV8",  _ifv, "IFV8", "ColorOrange"] spawn f_fnc_localGroupMarker;
