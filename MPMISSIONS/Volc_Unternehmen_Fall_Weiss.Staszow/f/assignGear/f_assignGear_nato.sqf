...
_rifle = "LIB_G43";
_riflemag = "lib_10Rnd_792x57";
_riflemag_tr = "lib_10Rnd_792x57";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "LIB_K98";
_carbinemag = "lib_5Rnd_792x57";
_carbinemag_tr = "lib_5Rnd_792x57";
...
// Backpacks
_bagsmall = "B_LEN_SS_A_frame3";			// carries 120, weighs 20
_bagmedium = "B_LEN_SS_A_frame3";				// carries 240, weighs 30
_baglarge =  "B_LIB_GER_SapperBackpack_empty"; 			// carries 320, weighs 40
_bagrad = "B_LIB_GER_Radio";
_bagmediumdiver =  "B_AssaultPack_blk";		// used by divers
_bagmedic = "B_LIB_SOV_RA_MedicalBag_Empty";
_baguav = "B_LIB_GER_Radio";			// used by UAV operator
...
_baseUniform = ["U_LEN_SS_Schutze2","U_LEN_SS_Driver"];
_baseHelmet = ["H_LEN_SS_Helmet_E"];
_baseGlasses = [];

// Vests
_lightRig = ["V_BandollierB_cbr","V_BandollierB_khk"];
_mediumRig = ["V_LEN_SS_VestG43","V_LEN_SS_VestKar98"]; 	// default for all infantry classes
_heavyRig = ["V_LEN_SS_VestG43"];

// Diver
_diverUniform =  ["U_LEN_SS_SecLeader"]; // FTL and SLs
_diverHelmet = ["H_LEN_SS_Cap"];
_diverRig = ["V_LEN_SS_FieldOfficer"];
_diverGlasses = [];

// Diver
_doctorUniform =  ["U_LEN_SS_Medic2"]; // FTL and SLs
_doctorHelmet = ["H_LEN_SS_Helmet_Medic"];
_doctorRig = ["V_LEN_SS_VestG43"];
_doctorGlasses = [];

// Pilot
_pilotUniform = ["U_LIB_GER_LW_pilot"]; // Luftwaffe Pilots
_pilotHelmet = ["sab_wwiplanes_ger_cap"];
_pilotRig = ["V_LIB_SOV_RA_Belt"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["U_LEN_SS_Tank_crew_unterofficer"]; // Panzer Crews
_crewHelmet = ["H_LEN_SS_TankPrivateCap"];
_crewRig = ["V_LIB_WP_Kar98Vest"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["U_LEN_SS_Scharfschutze"]; // Marksmen
_ghillieHelmet = ["H_LEN_SS_Cap"];
_ghillieRig = ["V_LEN_SS_VestG43"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["U_LEN_SS_Oberfuhrer"]; // CO
_sfhelmet = ["H_LEN_SS_OfficerCap"];
_sfRig = ["V_LEN_SS_TankPrivateBelt"];
_sfGlasses = [];
...
// LOADOUT: MEDIC
	case "m":
	{
		...
		_unit addItem "LIB_ACC_K98_Bayo";
...
// LOADOUT: VEHICLE GUNNER
	case "vg": // Panzer Division Commander
	{
		_unit addmagazines [_glriflemag,3];
		_unit addweapon _glrifle;					//_COrifle
		_unit addWeapon "LIB_Binocular_GER";
		removeHeadgear _unit;
		_unit addHeadgear "H_LEN_SS_TankOfficerCap";
	};
...
// LOADOUT: UAV OPERATOR
	case "uav":
	{
		...
		_unit addmagazines [_grenade,1];
		removeHeadgear _unit;
		_unit addHeadgear "H_LEN_SS_Cap_Radio";
		["uav"] call _backpack;
	};
