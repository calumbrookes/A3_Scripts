...
// ATTACHMENTS - PRIMARY
_attach1 = "rhs_acc_2dpZenit";	// IR Laser
...
_smokegrenade = "rhs_mag_nspn_red";
...
// Automatic Rifleman
_AR = "rhs_weap_akm";
_ARmag = "rhs_30Rnd_762x39mm";
_ARmag_tr = "rhs_30Rnd_762x39mm";

// Medium MG
_MMG = "rhs_weap_akm";
_MMGmag = "rhs_30Rnd_762x39mm";
_MMGmag_tr = "rhs_30Rnd_762x39mm";
...
// Marksman rifle
_DMrifle = "rhs_weap_akm";
_DMriflemag = "rhs_30Rnd_762x39mm";
...
// Woodland-Hex
_baseUniform = ["rhs_uniform_gorka_r_g"];
_baseHelmet = ["rhs_6b27m_green_ess"];
_baseGlasses = [];
...
// Vests
_lightRig = ["rhs_6sh92_digi_radio"];
_mediumRig = ["rhs_6sh92_digi_radio"]; 	// default for all infantry classes
_heavyRig = _mediumRig;

// Diver
_diverUniform =  ["rhs_uniform_m88_patchless"];
_diverHelmet = ["MNP_Beret_VDV"];
_diverRig = [];
_diverGlasses = [];
	...
	// explosives crates
{
		...
		_unit addWeaponCargoGlobal [_rifle, 50];
};
	...
	// AK crate
{
		...
		_unit addMagazineCargoGlobal [_mgrenade, 50];
		_unit addItemCargoGlobal [_satchel, 50];
};
