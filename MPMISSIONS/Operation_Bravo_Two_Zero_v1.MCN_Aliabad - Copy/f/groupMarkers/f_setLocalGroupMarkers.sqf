...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		...
		["GrpNATO_Eng1", 1, "ARTY", "ColorGreen"] spawn f_fnc_localGroupMarker;

		["UnitNATO_CO_M", 0, "DEMO", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_CO_D", 0, "DEMO", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_CO_REC", 0, "REC", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_A1_M", 0, "AM", "ColorRed"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_B1_M", 0, "BM", "ColorBlue"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_C1_M", 0, "CM", "ColorGreen"] spawn f_fnc_localSpecialistMarker;
		["coy1", 0, "[CMD]", "ColorYellow"] spawn f_fnc_localSpecialistMarker;
		["coy2", 0, "[A]", "ColorRed"] spawn f_fnc_localSpecialistMarker;
		["coy3", 0, "[B]", "ColorBlue"] spawn f_fnc_localSpecialistMarker;
		["coy4", 0, "[C]", "ColorGreen"] spawn f_fnc_localSpecialistMarker;
