...
if(_typeOfUnit != "NIL") then {
  ...
  if(!f_radios_settings_tfr_disableRadios) then {
      ...
      _rifradio = ["ar","aar","rat","samag","mmgag","hmgag","matag","hatag","mtrag","sp","car","smg","gren"];

      // Set the list of units that get a shortrange radio
      _shortrange = ["co", "dc", "ftl", "m", "samg", "mmgg", "matg", "sn", "mtrg","r","dmr","dm","eng","pp","pcc","pc","uav"];
