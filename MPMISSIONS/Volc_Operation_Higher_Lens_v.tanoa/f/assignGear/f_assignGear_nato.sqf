...
_scope2 = "optic_Arco_blk_F";	// ARCO Scope - 1x - 6x
_scope3 = "optic_LRPS_tna_F";	// SOS Scope - 18x - 75x
...
// Backpacks
_bagsmall = "B_ViperHarness_oli_F";			// carries 120, weighs 20
_bagmedium = "B_ViperHarness_oli_F";				// carries 240, weighs 30
...
_baseUniform = ["U_B_CTRG_Soldier_F","U_B_CTRG_Soldier_3_F","U_B_CTRG_Soldier_2_F","U_B_CTRG_Soldier_F","U_B_CTRG_Soldier_3_F"];
_baseHelmet = ["H_HelmetB_Enh_tna_F","H_HelmetB_Enh_tna_F","H_Booniehat_tna_F","H_HelmetB_Enh_tna_F","H_HelmetB_tna_F","H_HelmetB_Light_tna_F"];
_baseGlasses = [];

// Vests
_lightRig = ["V_PlateCarrier1_rgr_noflag_F","V_PlateCarrier1_rgr_noflag_F"];
_mediumRig = ["V_PlateCarrier1_rgr_noflag_F","V_PlateCarrier1_rgr_noflag_F"]; 	// default for all infantry classes
...
// Ghillie
_ghillieUniform = ["U_B_T_FullGhillie_tna_F"]; //DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = [];
...
// LOADOUT: COMMANDER
	case "co":
	{
		...
		this addHeadgear "MNP_Beret_Green";
...
if ((group _unit) == GrpNATO_CO) then {_unit addmagazines ["SmokeShellYellow",2]};
if ((group _unit) == GrpNATO_DC) then {_unit addmagazines ["SmokeShellYellow",2]};
if ((group _unit) == GrpNATO_ASL) then {_unit addmagazines ["SmokeShellPurple",2]};
if ((group _unit) == GrpNATO_BSL) then {_unit addmagazines ["SmokeShellBlue",2]};
if ((group _unit) == GrpNATO_CSL) then {_unit addmagazines ["SmokeShellOrange",2]};
if ((group _unit) == GrpNATO_A1) then {_unit addmagazines ["SmokeShellPurple",2]};
if ((group _unit) == GrpNATO_A2) then {_unit addmagazines ["SmokeShellPurple",2]};
if ((group _unit) == GrpNATO_A3) then {_unit addmagazines ["SmokeShellPurple",2]};
if ((group _unit) == GrpNATO_B1) then {_unit addmagazines ["SmokeShellBlue",2]};
if ((group _unit) == GrpNATO_B2) then {_unit addmagazines ["SmokeShellBlue",2]};
if ((group _unit) == GrpNATO_B3) then {_unit addmagazines ["SmokeShellBlue",2]};
if ((group _unit) == GrpNATO_C1) then {_unit addmagazines ["SmokeShellOrange",2]};
if ((group _unit) == GrpNATO_C2) then {_unit addmagazines ["SmokeShellOrange",2]};
if ((group _unit) == GrpNATO_C3) then {_unit addmagazines ["SmokeShellOrange",2]};
if ((group _unit) == GrpNATO_AH1) then {_unit addmagazines ["SmokeShellYellow",2]};
if ((group _unit) == GrpNATO_TH1) then {_unit addmagazines ["SmokeShellYellow",2]};
if ((group _unit) == GrpNATO_TH2) then {_unit addmagazines ["SmokeShellYellow",2]};
if ((group _unit) == GrpNATO_TH3) then {_unit addmagazines ["SmokeShellYellow",2]};
