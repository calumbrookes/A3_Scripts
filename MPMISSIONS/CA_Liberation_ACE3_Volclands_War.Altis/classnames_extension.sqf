...
opfor_sentry = "CA_Argentina_Falklands_des_rifleman";
opfor_rifleman = "CA_Argentina_Falklands_des_rifleman";
opfor_grenadier = "CA_Argentina_Falklands_des_grenadier";
opfor_squad_leader = "CA_Argentina_Falklands_des_officer_armoured";
opfor_team_leader = "CA_Argentina_Falklands_des_sergeant";
opfor_marksman = "CA_Argentina_Falklands_des_marksman";
opfor_machinegunner = "CA_Argentina_Falklands_des_machinegunner";
opfor_heavygunner = "CA_Argentina_Falklands_des_machinegunner";
opfor_medic = "CA_Argentina_Falklands_des_medic";
opfor_rpg = "CA_Argentina_Falklands_des_rpg26";
opfor_at = "CA_Argentina_Falklands_des_rpg_AT";
opfor_aa = "CA_Argentina_Falklands_des_aa";
opfor_officer = "CA_Argentina_Falklands_des_officer";
opfor_sharpshooter = "CA_Argentina_Falklands_des_marksman";
opfor_sniper = "CA_Argentina_Falklands_des_marksman";
opfor_engineer = "CA_Argentina_Falklands_des_engineer";
opfor_paratrooper = "CA_Argentina_Falklands_des_engineer";

// OPFOR Vehicles to be used in secondary objectives
opfor_mrap = "rhs_uaz_open_vdv";
opfor_mrap_armed = "rhs_gref_BRDM2_vdv";
