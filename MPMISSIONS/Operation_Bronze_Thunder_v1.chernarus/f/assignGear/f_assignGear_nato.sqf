...
_silencer1 = "hlc_muzzle_snds_fal";	// Rifle Supressor
_silencer2 = "UK3CB_BAF_Silencer_L115A3";	// Sniper Supressor
_silencer3 = "muzzle_snds_L"; // smg silencer
_silencer4 = "UK3CB_BAF_Silencer_L110"; // LMG silencer
_silencer5 = "hlc_muzzle_snds_M14"; // DMR Silencer

_scope1 = "FHQ_optic_MicroCCO";	// Holosight for SMG
_scope2 = "optic_Hamr";			// MRCO Scope - 1x - 6x
_scope3 = "UK3CB_BAF_SB31250";			// Sniper Scope - 18x - 75x
_scope4 = "FHQ_optic_AIM"; // LMG Scope
_scope5 = "optic_DMS"; // DMR Scope
...
_riflemag = "hlc_20Rnd_762x51_S_fal";
_riflemag_tr = "hlc_20Rnd_762x51_S_fal";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = "hlc_rifle_falosw";
_carbinemag = "hlc_20Rnd_762x51_S_fal";
_carbinemag_tr = "hlc_20Rnd_762x51_S_fal";
...
_glriflemag = "hlc_20Rnd_762x51_S_fal";
_glriflemag_tr = "hlc_20Rnd_762x51_S_fal";
...
_glIRcam = "ACE_HuntIR_M203";
_glIRmon = "ACE_HuntIR_monitor";
...
// Automatic Rifleman
_MMG = "UK3CB_BAF_L110A2";
_MMGmag = "UK3CB_BAF_100Rnd";
_MMGmag_tr = "UK3CB_BAF_100Rnd";
...
// Sniper
_SNrifle = "UK3CB_BAF_L115A3";
_SNrifleMag = "UK3CB_BAF_L115A3_Mag";
...
_baseUniform = ["MNP_CombatUniform_PPU_A"];
_baseHelmet = ["MNP_Helmet_BLK"];
_baseGlasses = [];

// Vests
_lightRig = ["V_BandollierB_cbr","V_BandollierB_khk"];
_mediumRig = ["MNP_Vest_USMC_Xtreme_A"]; 	// default for all infantry classes
...
// LOADOUT: DESIGNATED MARKSMAN
	case "dm":
	{
		...
		_unit addweapon _pistol;
		["dm"] call _backpack;
		_attachments = [_attach1,_scope5,_silencer5];
	};
...
// LOADOUT: SNIPER
	case "sn":
	{
		...
		_unit addweapon _pistol;
		_unit addmagazines [_smokegrenade,2];
		_attachments = [_attach1,_scope3,_silencer2,_bipod2];
	};
...
// LOADOUT: ENGINEER (DEMO)
	case "eng":
	{
		...
		_unit addweapon _smg;
		_attachments = [_attach1,_silencer3,_scope1];
		_unit addmagazines [_smokegrenade,2];
		_unit addmagazines [_grenade,1];
		_unit addmagazines [_mgrenade,1];
