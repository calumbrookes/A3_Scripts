...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		...
		["UnitNATO_CO_DEM1", 0, "DEMO", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_CO_DEM2", 0, "DEMO", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		...
		["GrpNATO_ST1",  4, "REC", "ColorYellow"] spawn f_fnc_localGroupMarker;

		["GrpNATO_TH1",  9, "CAS1", "ColorBlack"] spawn f_fnc_localGroupMarker;
 		["GrpNATO_TH2",  9, "CAS2", "ColorBlack"] spawn f_fnc_localGroupMarker;
 		["GrpNATO_TH3",  9, "CAS3", "ColorBlack"] spawn f_fnc_localGroupMarker;
 		["GrpNATO_TH4",  9, "CAS4", "ColorBlack"] spawn f_fnc_localGroupMarker;
		...
		["GrpFIA_ASL", 0, "CMD", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpFIA_A1", 1, "ONE", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpFIA_B1", 1, "TWO", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpFIA_ST1",  4, "REC", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["UnitFIA_ASL_M", 0, "MED", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
...
// Markers seen by players in CSAT slots.
	...
	case "opf_f":
	{
		["GrpCSAT_CO", 0, "CMD", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_DC", 0, "DC", "ColorYellow"] spawn f_fnc_localGroupMarker;

		["GrpCSAT_ASL", 0, "ASL", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_A1", 1, "ALPHA", "ColorRed"] spawn f_fnc_localGroupMarker;
		...
		["GrpCSAT_B1", 1, "BRAVO", "ColorBlue"] spawn f_fnc_localGroupMarker;
		...
		["GrpCSAT_C1", 1, "CHARLIE", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_C2", 1, "C2", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_C3", 1, "C3", "ColorGreen"] spawn f_fnc_localGroupMarker;

		["GrpCSAT_D1", 1, "DELTA", "ColorOrange"] spawn f_fnc_localGroupMarker;
		...
		["sub_1", 0, "SUB", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_2", 0, "SUB", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_3", 0, "SUB", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_4", 0, "SUB", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_5", 0, "SUB", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_6", 0, "SUB", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_7", 0, "SUB", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_8", 0, "SUB", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_9", 0, "SUB", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["sub_10", 0, "SUB", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
	};
...
// Markers seen by players in BLUFOR-FIA slots.
	...
	case "blu_g_f":
	{
		["GrpNATO_CO", 0, "CO", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["UnitNATO_CO_DEM1", 0, "DEMO", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_CO_DEM2", 0, "DEMO", "ColorBlack"] spawn f_fnc_localSpecialistMarker;

		["GrpNATO_ASL", 0, "ALPHA", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpNATO_BSL", 0, "BRAVO", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpNATO_CSL", 0, "CHARLIE", "ColorBlack"] spawn f_fnc_localGroupMarker;

		["GrpNATO_ST1",  4, "REC", "ColorBlack"] spawn f_fnc_localGroupMarker;
		...
		["UnitNATO_CO_M", 0, "MED", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_ASL_M", 0, "MED", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_BSL_M", 0, "MED", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_CSL_M", 0, "MED", "ColorBlack"] spawn f_fnc_localSpecialistMarker;

		["GrpFIA_ASL", 0, "CMD", "ColorBlue"] spawn f_fnc_localGroupMarker;
		["GrpFIA_A1", 1, "ONE", "ColorBlue"] spawn f_fnc_localGroupMarker;
		["GrpFIA_B1", 1, "TWO", "ColorBlue"] spawn f_fnc_localGroupMarker;
		["GrpFIA_ST1",  4, "REC", "ColorRed"] spawn f_fnc_localGroupMarker;
		["UnitFIA_ASL_M", 0, "MED", "ColorBlue"] spawn f_fnc_localSpecialistMarker;
