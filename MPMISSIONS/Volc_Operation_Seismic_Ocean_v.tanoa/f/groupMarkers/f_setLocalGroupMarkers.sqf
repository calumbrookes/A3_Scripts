...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		...
		["GrpNATO_ASL", 0, "ASL", "ColorCivilian"] spawn f_fnc_localGroupMarker;
		["GrpNATO_A1", 1, "A1", "ColorCivilian"] spawn f_fnc_localGroupMarker;
		["GrpNATO_A2", 1, "A2", "ColorCivilian"] spawn f_fnc_localGroupMarker;
		["GrpNATO_A3", 1, "A3", "ColorCivilian"] spawn f_fnc_localGroupMarker;
		...
		["GrpNATO_CSL", 0, "CSL", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNATO_C1", 1, "C1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNATO_C2", 1, "C2", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNATO_C3", 1, "C3", "ColorOrange"] spawn f_fnc_localGroupMarker;
		...
		["UnitNATO_CO_FAC", 1, "FAC", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_A1_M", 0, "A1M", "ColorCivilian"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_B1_M", 0, "B1M", "ColorBlue"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_C1_M", 0, "C1M", "ColorOrange"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_A2_M", 0, "A2M", "ColorCivilian"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_B2_M", 0, "B2M", "ColorBlue"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_C2_M", 0, "C2M", "ColorOrange"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_ASL_JTAC", 0, "JTAC", "ColorCivilian"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_BSL_JTAC", 0, "JTAC", "ColorBlue"] spawn f_fnc_localSpecialistMarker;
		["UnitNATO_CSL_JTAC", 0, "JTAC", "ColorOrange"] spawn f_fnc_localSpecialistMarker;

		["VehNATO_TH1", 0, "TH1", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["VehNATO_TH2", 0, "TH2", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["VehNATO_TH3", 0, "TH3", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
		["VehNATO_AH1", 0, "CAS", "ColorBlack"] spawn f_fnc_localSpecialistMarker;
