...
_attach3 = "UK3CB_BAF_LLM_Flashlight_Black";	// dmr Flashlight

_silencer1 = "rhsusf_acc_nt4_black";	// 5.56 suppressor
_silencer2 = "muzzle_snds_H";	// 6.5 suppressor
_silencer3 = "UK3CB_BAF_Silencer_L115A3"; // dmr silencer
_silencer4 = "muzzle_snds_L"; // smg silencer

_scope1 = "rhsusf_acc_compm4";	// Holosight
_scope2 = "FHQ_optic_MicroCCO";			// MRCO Scope - 1x - 6x
_scope3 = "optic_SOS";			// SOS Scope - 18x - 75x
_scope4 = "UK3CB_BAF_TA648_308"; // dmr scope
...
_rifle = "rhs_weap_m4a1";
_riflemag = "hlc_30rnd_556x45_S";
_riflemag_tr = "hlc_30rnd_556x45_S";
...
_smg = "hlc_smg_mp5a4";
_smgmag = "hlc_30Rnd_9x19_SD_MP5";
_smgmag_tr = "hlc_30Rnd_9x19_SD_MP5";
...
_bagmedium = "B_AssaultPack_blk";			// carries 240, weighs 30
_baglarge =  "B_AssaultPack_blk"; 			// carries 320, weighs 40
...
_baseUniform = ["U_B_Wetsuit"];
_baseHelmet = [];
_baseGlasses = ["G_Diving"];

// Vests
_lightRig = ["V_RebreatherB"];
_mediumRig = ["V_RebreatherB"]; 	// default for all infantry classes
_heavyRig = ["V_RebreatherB"];
...
// LOADOUT: DEPUTY COMMANDER AND SQUAD LEADER
	...
	{
		["g"] call _backpack;
		_unit addmagazines [_IRgren,3];
		_unit addmagazines [_chemblue,2];
...
// LOADOUT: MEDIC
	case "m":
	{
		...
		_attachments = [_attach1,_scope2,_silencer4];
	...
	case "crate_small":
{
		...
		_unit addMagazineCargoGlobal [_IRgren, 2];
		_unit addMagazineCargoGlobal [_grenade, 2];
		_unit addMagazineCargoGlobal [_mgrenade, 2];
		_unit addMagazineCargoGlobal [_smokegrenadeblue, 2];
		_unit addMagazineCargoGlobal [_smokegrenadered, 2];
		_unit addMagazineCargoGlobal [_chemred, 5];
		_unit addMagazineCargoGlobal [_chemblue, 5];
		_unit addItemCargoGlobal [_firstaid, 15];
		_unit addItemCargoGlobal [_satchel, 2];
};
	...
	case "crate_med":
{
		...
		_unit addMagazineCargoGlobal [_IRgren, 20];
		_unit addMagazineCargoGlobal [_grenade, 15];
		_unit addMagazineCargoGlobal [_mgrenade, 15];
		_unit addMagazineCargoGlobal [_smokegrenadeblue, 25];
		_unit addMagazineCargoGlobal [_smokegrenadered, 25];
		...
		_unit addItemCargoGlobal [_satchel, 20];
	...
	case "crate_large":
{
		...
		_unit addMagazineCargoGlobal [_IRgren, 5];
		_unit addMagazineCargoGlobal [_grenade, 2];
		_unit addMagazineCargoGlobal [_mgrenade, 2];
		_unit addMagazineCargoGlobal [_smokegrenadeblue, 2];
		_unit addMagazineCargoGlobal [_smokegrenadered, 2];
		_unit addMagazineCargoGlobal [_chemred, 10];
		_unit addMagazineCargoGlobal [_chemblue, 10];
		_unit addItemCargoGlobal [_firstaid, 15];
};
