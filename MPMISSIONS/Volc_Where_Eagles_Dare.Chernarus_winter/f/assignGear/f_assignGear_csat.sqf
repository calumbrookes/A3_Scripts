...
_rifle = "LIB_MP40";
_riflemag = "LIB_32Rnd_9x19";
_riflemag_tr = "LIB_32Rnd_9x19";
...
// Backpacks
_bagsmall = "B_LIB_GER_A_frame";			// carries 120, weighs 20
_bagmedium = "B_LIB_GER_A_frame";			// carries 200, weighs 30
_baglarge =  "B_LIB_GER_A_frame"; 			// carries 320, weighs 40
_bagradio = "B_LIB_US_Radio";
...
// Woodland-Hex
_baseUniform = ["U_LIB_GER_Officer_camo_w"];
_baseHelmet = [];
_baseGlasses = [];
...
// Vests
_lightRig = ["V_LEN_SS_SniperBelt"];
_mediumRig = ["V_LEN_SS_SniperBelt"]; 	// default for all infantry classes
_heavyRig = _mediumRig;

// Diver
_diverUniform =  ["U_LIB_GER_Officer_camo_w"];
_diverHelmet = [];
_diverRig = ["V_RebreatherIR"];
_diverGlasses = ["G_Diving"];

// Pilot
_pilotUniform = ["U_LIB_GER_Officer_camo_w"];
_pilotHelmet = ["H_PilotHelmetHeli_O"];
_pilotRig = ["V_HarnessO_brn"];
_pilotGlasses = [];

// Crewman
_crewUniform = ["U_LIB_GER_Officer_camo_w"];
_crewHelmet = ["H_HelmetCrew_O"];
_crewRig = ["V_HarnessO_brn"];
_crewGlasses = [];

// Ghillie
_ghillieUniform = ["U_LIB_GER_Officer_camo_w"]; //DLC alternatives: ["U_O_FullGhillie_lsh","U_O_FullGhillie_ard","U_O_FullGhillie_sard"];
_ghillieHelmet = [];
_ghillieRig = ["V_Chestrig_khk"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["U_LIB_GER_Officer_camo_w"];
...
// LOADOUT: COMMANDER
	case "co":
	{
		...
		_unit addHeadgear "H_LIB_GER_OfficerCap";
		["g"] call _backpack;
	};
...
// LOADOUT: DEPUTY COMMANDER AND SQUAD LEADER
	case "dc":
	{
		...
		_unit addWeapon "LIB_Binocular_GER";
		_unit linkItem "ItemGPS";
		_unit addHeadgear "H_LIB_GER_Cap";
		["g"] call _backpack;
	};
