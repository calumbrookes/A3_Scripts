...
// Markers seen by players in CSAT slots.
	...
	case "opf_f":
	{
		...
		["GrpCSAT_A1", 1, "A", "ColorRed"] spawn f_fnc_localGroupMarker;
		...
		["GrpCSAT_B1", 1, "B", "ColorBlue"] spawn f_fnc_localGroupMarker;
		...
		["GrpCSAT_C1", 1, "C", "ColorGreen"] spawn f_fnc_localGroupMarker;
